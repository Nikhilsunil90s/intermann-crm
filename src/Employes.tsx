        ...
        <div className='p-2'>
            <div className="text-center py-3">
                <span className='hero-title'>
                    <h3>ADD A candidats / employes</h3>
                </span>
            </div>
            <div>
                    ...
                    <div className="d-flex flex-wrap justify-content-around">
                        <div className="col-md-6">
                            <div className="p-2">
                                ...
                                <span className='text-small'>Mendatory, please add company client</span>
                            </div>
                            <div className="p-2">
                                ...
                                <span className="text-small">NOT Mendatory, please add phone client with +() . exemple : +33623167260</span>
                            </div>
                            <div className="p-2">
                            ...
                            <div className="p-2">
                                ...
                                <input type="text" className="form-control" placeholder='Facebook link' name='companyContactName' value={data.companyContactName} onChange={onFormDataChange} />
                                <span className="text-small"> NOT Mendatory, please add contact person on this company.</span>
                            </div>
                            <div className="p-2">
                                <label>Skills / Notes Compétances (will be displayed on CV)</label>
                         ...
                         <div>   <input type="radio" /><span>Yes (B)</span></div> 
                         <div>    <input type="radio" /><span>No</span></div> 
                             </div>
                             <div className='col-6'>
                             <p>Voyage en voiture vers France ?</p>
                            <div> <input type="radio" /><span>Yes</span></div>
                            <div>    <input type="radio" /><span>No</span></div>
                             </div>
                         </div>
                        </div>
                        <div className="col-md-6">
                            ...
                            <div className="p-2">
                                ...
                                <input type="number" className="form-control"  name='postCount' placeholder="42"  />
                ...
                <span className="ps-2">Autre</span>
                            ...
                            <div className="p-2">
                                <div className="card card-body">
                                    <label className='fw-bold'>Quand ce candidat a besoin de travailler When this candidate is ready to work with us</label>
                                    <br />
                        ...
                        <div className="col-md-12">
                            <p>Expérience du candidat (fill only lines, higher = more recent)</p>
