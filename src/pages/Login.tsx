...
export default function Login() {
    ...
    const onCredsChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        <main>
            <div className="d-flex justify-content-between">
                <div className="bg-dark p-1">
                    <button className="btn btn-dark">VOIR LE SITE EN ROUMAIN</button>
                </div>
                <div className="bg-dark p-1">
                    <button className="btn btn-dark">VOIR LE SITE EN ROUMAIN</button>
                </div>
                ...
                <form className="login-panel" onSubmit={onLoginFormSubmit}>
                    ...
                    <div className='mx-auto py-4'>
                        ...
                        <div className='d-flex'>
                            <button className="mx-auto btn sign-in-btn" type='submit'>
                                SIGN IN
                            </button>
                        </div>
                    </div>
