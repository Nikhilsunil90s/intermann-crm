                        ...
                        <div className="d-flex input-box">
                            <span className='icon'>
                                <svg width="3rem" height="3rem" viewBox="0 0 83 83" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M28.1872 33.801H59.0012C60.8921 33.801 62.425 35.3339 62.425 37.2248V61.1912C62.425 63.0821 60.8921 64.615 59.0012 64.615H28.1872C26.2963 64.615 24.7634 63.0821 24.7634 61.1912V37.2248C24.7634 35.3339 26.2963 33.801 28.1872 33.801Z" stroke="#FE8700" strokeWidth="2.4" strokeLinejoin="round" />
                                    <path d="M32.6099 33.801V25.1063C32.6099 19.0397 37.5278 14.1217 43.5945 14.1217C49.6611 14.1217 54.5791 19.0397 54.5791 25.1063V25.1745V25.1745V33.801" stroke="#FE8700" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            </span>
                            <span className='input'>
