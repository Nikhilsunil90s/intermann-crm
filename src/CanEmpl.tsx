...
<div className="box">
    ...
    <p>Métier e</p>
        ...
        <hr className="new5" />
        <div className="col-3"><div className="card card-color" >
            <div className="card-upper"><div className="col-4"> <img src={require("./images/card-men.svg").default} className="card-img-top" alt="..." />
            </div>
            <div className="col-7 "> 
            <p>Candidats_name</p>
            <p>Candidats_Age</p>
...
<p>Ready for work : From date To date  </p>
<p>Ready for work : From date To date  </p>
